...
public class CompanyRepositoryImpl implements CompanyRepository {
    ...
    public Company find(Long id) {
        ...
        Fetch<Company, Department> departmentFetch = root.fetch(Company.departments, JoinType.LEFT);
        Fetch<Department, Employee> employeeFetch = departmentFetch.fetch(Department.employees, JoinType.LEFT);
        employeeFetch.fetch(Employee.address, JoinType.LEFT);
        departmentFetch.fetch(Department.offices, JoinType.LEFT);
